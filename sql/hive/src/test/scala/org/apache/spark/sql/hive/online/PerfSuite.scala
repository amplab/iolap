...
class PerfSuite extends FunSuite {
  ...
  ignore("poisson") {
    ...
    val sum = Array.fill(16)(0)
    val table = Array(-567453481, 1012576688, 1802591772, 2065930134, 2131764724, 2144931642,
      2147126128, 2147439627, 2147478814, 2147483168, 2147483603, 2147483643, 2147483646,
      2147483646, 2147483646, 2147483647) // [-2147483648, 2147483647]
    ...
    println(sum.map(_ / n.toDouble).mkString(", "))
  }
